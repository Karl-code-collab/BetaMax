...
public class BetaMax {
    ...
    public BetaMax() { // constructor (initializes the system with a default admin account.)
    ...
    private int getMenuChoice() { // will return an int menu choice
    ...
    private void requestorMenu(Requestor requestor) {
        while (true) {
            ...
            System.out.println("3. View Blood Bank Inventory"); // check the inventory/ stocks
